...
class HillstoneSG6000Handler(CommandHandler):
    """ Cisco Nexus Command Handler """

    info = DeviceBaseInfo(
        vendor="hillstone",
        model="sg6000",
        version="*",
        description="Hillstone SG6000 Command Handler"
    )
    ...
    def __init__(self, process: SSHServerProcess, conf_path: str = None):
        ...
        if conf_path is None:
            ...
            conf_path = f"{cwd_path}/hillstone_sg6000.yml"

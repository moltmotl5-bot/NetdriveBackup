...
from netdriver_simunet.server.handlers import CommandHandler, CommandHandlerFactory
from netdriver_simunet.server.user_repo import UserRepo


# Module-level logger with patched name for correct filtering
def _patch_record(record):
    """Patch the record to ensure it's identified as netdriver_simunet.server"""
    record["name"] = __name__  # __name__ will be "netdriver_simunet.server.device"
